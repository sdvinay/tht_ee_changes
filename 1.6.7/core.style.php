...
class Style {
	...
	function Style()
    {
      ...
      // BEGIN_THT: MODIFIED BY VINAY 3/25/06, and again on 5/28/08                                               
      // Why does EE set the expiration for ten years out  That's way too long.
      // We've been using 3 hours in the past, let's stick with that
