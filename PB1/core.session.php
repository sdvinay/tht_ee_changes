...
class Session

 {
    ...
    var $cpan_session_len = 7200;  // Admin sessions expire in two hours
    ...
    {  
		...
		$query = $DB->query("SELECT can_view_offline_system,
									can_view_online_system, 
									can_view_profiles,
									can_email_from_profile,
									can_post_comments 
							FROM exp_member_groups WHERE group_id = '3'");
    ...
    {  
        ...
        {
        	$sql = "UPDATE exp_members set last_visit = '".$LOC->now."' WHERE member_id = '".$this->sdata['member_id']."'";
    ...
    {    
		...
		$sql = "INSERT INTO exp_password_lockout (login_date, ip_address, user_agent) VALUES ('".time()."', '".$IN->IP."', '".$this->userdata['user_agent']."')";  
