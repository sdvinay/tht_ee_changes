...
class Weblog {
    ...
    function fetch_pagination_data()
    {
		...
		{ 
			...
			//
				if ($EXT->active_hook('weblog_module_fetch_pagination_data'))
				{
...
// END_THT: DST fixes
	...
	function create_pagination($count = 0, $query = '')
	{
		...
		//
			if ($EXT->active_hook('weblog_module_create_pagination'))
			{
    ...
    function parse_weblog_entries()
    {
        ...
        {         
			...
			//
				if ($EXT->active_hook('weblog_entries_tagdata'))
				{
			...
			//
				if ($EXT->active_hook('weblog_entries_tagdata_end'))
				{
    ...
    function categories()
    {
		...
		//
			if ($EXT->active_hook('weblog_module_categories_start'))
			{
    ...
    function category_heading()
    {
		...
		//
			if ($EXT->active_hook('weblog_module_category_heading_start'))
			{
    ...
    function calendar()
    {
		...
		//
			if ($EXT->active_hook('weblog_module_calendar_start'))
			{
